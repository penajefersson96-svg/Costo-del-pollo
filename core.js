...
function canvasReporte(nombre,r){
  ...
  x.fillStyle='#61706A';x.font='600 26px '+F;x.fillText('Generado con Precio del Pollo',60,H-50);
  return c;
}
...
function buildSide(){
  ...
  side.innerHTML='<div class="side-head"><div class="biz">'+esc(negocio())+'</div><div class="prod">Sistema avícola</div></div>'+links.map(l=>'<a href="'+l[0]+'" class="'+(cur===l[0]?'on':'')+'"><svg viewBox="0 0 24 24"><path d="'+l[2]+'"/></svg><span>'+l[1]+'</span>'+''+'</a>').join('')+'<div class="side-foot">v2 · funciona offline</div>';
